...
function App() {
  ...
  const handlePayment = async (cardData)=>{
    const response = await fetch("https://razorpay-guvi-express.vercel.app/order",{
      method: "POST",
      body: JSON.stringify({
    ...
    var options = {
      ...
      "handler": async function (response){
        const validateResponse = await fetch("https://razorpay-guvi-express.vercel.app/order/validate",{
          method: "POST",
